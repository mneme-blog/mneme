...
check "server image pinned"      ghcr.io/mneme-blog/mneme-server:v0.3.0 "$(pin MNEME_SERVER_IMAGE)"
check "web image pinned"         ghcr.io/mneme-blog/mneme-web:v0.3.0    "$(pin MNEME_WEB_IMAGE)"
...
check "server image pinned"      ghcr.io/mneme-blog/mneme-server:main-abc1234 "$(pin MNEME_SERVER_IMAGE)"
check "web image pinned"         ghcr.io/mneme-blog/mneme-web:main-abc1234    "$(pin MNEME_WEB_IMAGE)"
